...
<div class="grid grid-cols-1 md:grid-cols-2 justify-center md:justify-between p-6 items-center">
        ...
        <router-link to="/kuis" class="p-4 hover:bg-gray-400 w-32  text-md font-bold text-white text-center rounded-full bg-gray-500 mr-4">Sebelumnya</router-link>
        <router-link to="/kuis3" class="p-4 hover:bg-primary-2 w-32  text-md font-bold text-white text-center rounded-full bg-primary">Selanjutnya</router-link>
        </div>
    </div>
</div>
</template>
