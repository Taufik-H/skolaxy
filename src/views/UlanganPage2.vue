...
<div class="w-full h-auto p-5 bg-white shadow-md mt-5 rounded-md">
    ...
    <div class=" p-5">
            <div class="text-md text-dark font-semibold">Salah satu jenis DBMS...</div>
...
<div class="grid grid-cols-1 md:grid-cols-2 justify-center md:justify-between p-6 items-center">
        ...
        <router-link to="/ulangan-page1" class="p-4 hover:bg-gray-400 w-32  text-md font-bold text-white text-center rounded-full bg-gray-500 mr-4">Sebelumnya</router-link>
        <router-link to="/ulangan-page3" class="p-4 hover:bg-primary-2 w-32  text-md font-bold text-white text-center rounded-full bg-primary">Selanjutnya</router-link>
        </div>
    </div>
</div>
</template>
