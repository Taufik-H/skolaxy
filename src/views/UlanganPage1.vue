...
<div class="grid grid-cols-1 md:grid-cols-2 justify-center md:justify-between p-6 items-center">
        ...
        <router-link to="/ulangan-page2" class="p-4 hover:bg-primary-2 w-32  text-md font-bold text-white text-center rounded-full bg-primary">Selanjutnya</router-link>
        </div>
    </div>
</div>
</template>
