  ...
  "node_modules/apexcharts/dist/apexcharts.common.js"(exports, module) {
    ...
    var dt = function() {
      ...
      return r(t2, [{ key: "getNearestValues", value: function(t3) {
        ...
        s2.globals.series.length > 1 ? r2 = this.getFirstActiveXArray(i2, a2) : o2 = 0;
      ...
      } }, { key: "getFirstActiveXArray", value: function(t3, e2) {
        for (var i2 = 0, a2 = t3.map(function(t4, i3) {
          return t4.length > 0 && e2[i3].length > 0 ? i3 : -1;
    ...
    var gt = function() {
      ...
      return r(t2, [{ key: "drawSeriesTexts", value: function(t3) {
        ...
        o2 && f2[0] && (c2 == null || l2.globals.collapsedSeriesIndices.indexOf(e2) > -1 ? f2[0].parentNode.style.display = "none" : f2[0].parentNode.style.display = l2.config.tooltip.items.display);
        ...
        if (l2 !== null)
          for (var h2 = 0; h2 < a2.globals.series.length; h2++) {
            ...
            if (a2.globals.comboCharts && c2 === void 0 && l2.splice(h2, 0, null), c2 && c2.length) {
              var d2 = o2[h2][t3][1];
              l2[h2].setAttribute("cx", s2), d2 !== null && !isNaN(d2) && d2 < a2.globals.gridHeight && d2 > 0 ? (l2[h2] && l2[h2].setAttribute("r", n2), l2[h2] && l2[h2].setAttribute("cy", d2)) : l2[h2] && l2[h2].setAttribute("r", 0);
            }
          }
